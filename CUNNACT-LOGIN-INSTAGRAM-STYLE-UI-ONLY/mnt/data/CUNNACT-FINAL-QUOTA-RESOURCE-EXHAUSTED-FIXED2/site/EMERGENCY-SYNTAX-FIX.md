...
Also rewrote the security-device rendering function in `js/profile.js` to remove a malformed nested template expression found during a full JavaScript syntax scan.
